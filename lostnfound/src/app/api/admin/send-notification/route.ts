...
export async function POST(request: NextRequest) {
  try {
    ...
    // Send email
    // For demo purposes, let's just log and pretend we sent
    // In production, you'd use BCC to send to all recipients
    console.log(`Would send email to ${users.length} recipients`);
